...
// Package bufiorw implements buffered I/O. It wraps an io.Reader or io.Writer
...
var errNegativeRead = errors.New("bufiorw: reader returned negative count from Read")
...
func (b *Reader) fill() {
	...
	if b.w >= len(b.buf) {
		panic("bufiorw: tried to fill full buffer")
	}
	...
	if err == ErrBufferFull {
		...
		if len(line) > 0 && line[len(line)-1] == '\r' {
			...
			if b.r == 0 {
				...
				panic("bufiorw: tried to rewind past start of buffer")
			}
			b.r--
...
var errNegativeWrite = errors.New("bufiorw: writer returned negative count from Write")
